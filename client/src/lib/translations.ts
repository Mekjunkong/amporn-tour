/**
 * Translations for Amporn Tour
 * English version for international travelers
 */
...
export const translations: any = {
  en: {
    ...
    about: {
      ...
      story: 'With deep local knowledge and a passion for hospitality, Amporn Tour specializes in creating memorable, personalized travel experiences. We work with travelers from around the world to ensure every tour is tailored to your interests and comfort.',
