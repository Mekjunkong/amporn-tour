...
export const tours: Tour[] = [
  ...
  {
    id: 'extreme-zipline-luge-kart-adventure',
    title: 'Extreme Zipline & Luge Kart Adventure',
    description: 'Experience the ultimate adventure with 38 platforms, 21 ziplines including 5 longest ziplines (900m, 400m, 350m), 2 abseil descents, 5 sky bridges, 6 staircases, plus the exclusive Jungle Luge Kart (2,100 meters - only one in Thailand) and Big Giant Swings (only one in Thailand). This extreme program offers up to 2 hours of total activity time with round-trip transfer, Thai buffet lunch, tea, and coffee included.',
    shortDescription: 'Ultimate adventure: 21 ziplines, jungle luge kart, and giant swings in one thrilling package',
    heroImage: '/images/extreme-zipline-1.webp',
    images: [
      { src: '/images/extreme-zipline-1.webp', alt: 'Ziplining through misty jungle mountains at sunrise' },
      { src: '/images/extreme-zipline-2.webp', alt: 'Two adventurers on tandem zipline through forest canopy' },
      { src: '/images/extreme-zipline-3.webp', alt: 'Tourists racing on jungle luge karts down mountain track' },
      { src: '/images/extreme-zipline-4.webp', alt: 'Adventurers on giant swing soaring above jungle' },
    ],
    activities: [
      '21 Ziplines (including 900m, 400m, 350m longest)',
      '2 Abseil Descents (15m, 30m)',
      '5 Sky Bridges',
      '6 Staircases',
      'Jungle Luge Kart 2,100m (Only One in Thailand)',
      'Big Giant Swings (Only One in Thailand)',
      'Nature Trail Walk',
    ],
    packageIncludes: [
      'Round-Trip Transfer',
    ...
    highlights: [
      '38 platforms with 21 ziplines including 900m longest',
      'Exclusive Jungle Luge Kart - 2,100 meters downhill (only one in Thailand)',
      'Big Giant Swings - unique thrill experience (only one in Thailand)',
      '2 abseil descents (15m and 30m) for vertical adventure',
      '5 sky bridges and 6 staircases through jungle canopy',
      'Nature trail walk with 6 minutes of scenic exploration',
      'Maximum weight support: 110kg, experienced multilingual guides',
    ],
    itinerary: 'Pickup from hotel at selected time. Transfer to adventure park base camp. Safety briefing and equipment fitting. Experience 38 platforms with 21 thrilling ziplines including the longest 900m zipline. Enjoy 2 abseil descents, cross 5 sky bridges, and climb 6 staircases. Race down the exclusive 2,100m Jungle Luge Kart track. Soar on the Big Giant Swings. Walk the nature trail. Enjoy Thai buffet lunch with tea, coffee, and seasonal fruit. Return to Chiang Mai. Note: Participants must be healthy, aged 10-65 years, max weight 110kg.',
    pricePerPerson: 2450,
    currency: 'THB',
    packageExcludes: ['Personal expenses', 'Photos and videos', 'Tips for guides'],
    paymentTerms: '50% deposit required to confirm booking, balance due 3 days before tour',
    cancellationPolicy: 'Free cancellation up to 7 days before tour. 50% refund for 3-7 days. No refund within 3 days.',
    notes: 'This is the EXTREME program featuring the longest ziplines, exclusive luge kart, and giant swings. Support maximum weight 110kg. Experienced English and Chinese-speaking guides available.',
  },
];
